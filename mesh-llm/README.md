...
For install and end-user usage, see the [project README](../README.md). For architecture, testing, and development, see [HUMANS.md](../HUMANS.md). For the wire protocol spec, see [docs/message_protocol.md](docs/message_protocol.md).
