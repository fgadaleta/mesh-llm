...
| Gemma 3 | 1B instruct | `tetf/gemma-3-1b-it-qat-q4_0-GGUF/gemma-3-1b-it-q4_0.gguf` | `mlx-community/gemma-3-1b-it-qat-4bit` | `HIGH` | 2026-04-06 | `PENDING` | `PENDING` | `PENDING` | `PENDING` | `PENDING` | `PENDING` | Switched to a tighter low-bit QAT pair. The previous `ggml-org Q4_K_M` vs `mlx qat-4bit` comparison was materially weaker. Future Gemma3 judgments should use this row instead. |
